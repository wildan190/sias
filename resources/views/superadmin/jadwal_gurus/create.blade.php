                ...
                <form method="POST" action="{{ route('superadmin.jadwal_gurus.store') }}">
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="hari" id="hari" class="mt-1 p-2 border rounded-md w-full" required placeholder="Pilih Hari">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="time" name="waktu" id="waktu" class="mt-1 p-2 border rounded-md w-full" required placeholder="Pilih Waktu">
                        </div>
                        <!-- Guru Pengampu -->
                        <div class="mb-4">
