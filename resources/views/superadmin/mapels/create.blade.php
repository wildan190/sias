    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form method="POST" action="{{ route('superadmin.mapels.store') }}">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="mapel_id" id="mapel_id" class="mt-1 p-2 border rounded-md w-full" required placeholder="Masukkan Nama ID Mata Pelajaran">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_mapel" id="nama_mapel" class="mt-1 p-2 border rounded-md w-full" required placeholder="Masukkan Nama Mapel">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="prodi" id="prodi" class="mt-1 p-2 border rounded-md w-full" required>
                            ...
                            <option value="{{ $program_studi->id }}">{{ $program_studi->nama_prodi }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="hidden" name="guru_pengampu" id="guru_pengampu" required />
                    </div>
