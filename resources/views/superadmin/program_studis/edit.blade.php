    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form method="POST" action="{{ route('superadmin.program_studis.update', $programStudi->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="prodi_id" id="prodi_id" class="mt-1 p-2 border rounded-md w-full" required value="{{ $programStudi->prodi_id }}" placeholder="Masukkan Id Prodi">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_prodi" id="nama_prodi" class="mt-1 p-2 border rounded-md w-full" required value="{{ $programStudi->nama_prodi }}" placeholder="Masukkan Nama Program Studi">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex items-center">
                            <input type="text" id="selected_ketua_prodi" class="border p-2 rounded-md mr-2" readonly value="{{ $programStudi->ketuaProdi->name ?? '' }}" placeholder="Pilih Ketua Prodi">
                            <button type="button" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onclick="openModal()">
                                Pilih Ketua Prodi
                            </button>
                        </div>
                        <input type="hidden" name="ketua_prodi" id="ketua_prodi" value="{{ $programStudi->ketua_prodi }}" />
                    </div>
