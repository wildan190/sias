            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('superadmin.gurus.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="username" id="username" placeholder="Masukkan username" class="rounded-md border-gray-300 dark:border-gray-700 focus:ring-blue-500 focus:border-blue-500 mt-1 block w-full">
                    </div>

                    <!-- NIK Guru -->
                    <div class="mb-4">
                        <label for="nik_guru" class="block text-sm font-medium text-gray-600 dark:text-gray-300">NIK Guru</label>
                        <input type="text" name="nik_guru" id="nik_guru" placeholder="Masukkan NIK Guru" class="rounded-md border-gray-300 dark:border-gray-700 focus:ring-blue-500 focus:border-blue-500 mt-1 block w-full">
                    </div>

                    <!-- Nama -->
                    <div class="mb-4">
                        <label for="name" class="block text-sm font-medium text-gray-600 dark:text-gray-300">Nama</label>
                        <input type="text" name="name" id="name" placeholder="Masukkan Nama Guru" class="rounded-md border-gray-300 dark:border-gray-700 focus:ring-blue-500 focus:border-blue-500 mt-1 block w-full">
                    </div>

                    <!-- Tanggal Lahir Guru -->
                    <div class="mb-4">
                        <label for="tanggal_lahir_guru" class="block text-sm font-medium text-gray-600 dark:text-gray-300">Tanggal Lahir Guru</label>
                        <input type="date" name="tanggal_lahir_guru" id="tanggal_lahir_guru" class="rounded-md border-gray-300 dark:border-gray-700 focus:ring-blue-500 focus:border-blue-500 mt-1 block w-full">
                    </div>

                    <!-- Email Guru -->
                    <div class="mb-4">
                        <label for="email_guru" class="block text-sm font-medium text-gray-600 dark:text-gray-300">Email Guru</label>
                        <input type="email" name="email_guru" id="email_guru" placeholder="Masukkan Email Guru" class="rounded-md border-gray-300 dark:border-gray-700 focus:ring-blue-500 focus:border-blue-500 mt-1 block w-full">
                    </div>

                    <!-- Nomor Telepon Guru -->
                    <div class="mb-4">
                        <label for="nomor_telepon_guru" class="block text-sm font-medium text-gray-600 dark:text-gray-300">Nomor Telepon Guru</label>
                        <input type="tel" name="nomor_telepon_guru" id="nomor_telepon_guru" placeholder="Masukkan Nomor Telepon Guru" class="rounded-md border-gray-300 dark:border-gray-700 focus:ring-blue-500 focus:border-blue-500 mt-1 block w-full">
                    </div>

                    <!-- Alamat Guru -->
                    <div class="mb-4">
                        <label for="alamat_guru" class="block text-sm font-medium text-gray-600 dark:text-gray-300">Alamat Guru</label>
                        <textarea name="alamat_guru" id="alamat_guru" placeholder="Masukkan Alamat Guru" class="rounded-md border-gray-300 dark:border-gray-700 focus:ring-blue-500 focus:border-blue-500 mt-1 block w-full"></textarea>
                    </div>

                    <!-- NIP Guru -->
                    <div class="mb-4">
                        <label for="nip_guru" class="block text-sm font-medium text-gray-600 dark:text-gray-300">NIP Guru</label>
                        <input type="text" name="nip_guru" id="nip_guru" placeholder="Masukkan NIP Guru" class="rounded-md border-gray-300 dark:border-gray-700 focus:ring-blue-500 focus:border-blue-500 mt-1 block w-full">
                    </div>

                    <!-- Spesialis -->
                    <div class="mb-4">
                        <label for="spesialis" class="block text-sm font-medium text-gray-600 dark:text-gray-300">Spesialis</label>
                        <input type="text" name="spesialis" id="spesialis" placeholder="Masukkan Spesialis Guru" class="rounded-md border-gray-300 dark:border-gray-700 focus:ring-blue-500 focus:border-blue-500 mt-1 block w-full">
                    </div>
