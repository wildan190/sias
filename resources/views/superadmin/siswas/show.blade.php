        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <div class="mt-auto text-left">
                    <a href="{{ route('superadmin.siswas.index') }}" class="bg-gray-300 dark:bg-gray-700 hover:bg-gray-400 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 font-bold py-2 px-4 rounded inline-flex items-center">
                ...
                <a href="{{ route('superadmin.siswas.exportPdf', $siswa->id) }}" class="btn btn-primary rounded">
